const lyTop1 = {
                            ...
                            <form action='' class='sui-form form-inline'> \
                                ...
                                <div class='input-append'> \
                                    <input type='text' id='autocomplete' v-model='key' \
                                         placeholder='手机'  class='input-error input-xxlarge'/> \
                    ...
                    <div class='yui3-u Right shopArea'> \
                        <div class='fr shopcar'> \
                            <div class='show-shopcar' id='shopcar'> \
                                <span class='car'></span> \
                                <a class='sui-btn btn-default btn-xlarge' href='http://www.llh.com/cart.html' target='_blank'> \
                                    <span>我的购物车</span> \
                                </a> \
    ...
    methods: {
        search() {
            if (this.key==null)
                window.location = 'http://www.llh.com/search.html?key=手机';
            else
                window.location = 'http://www.llh.com/search.html?key=' + this.key;
        },
